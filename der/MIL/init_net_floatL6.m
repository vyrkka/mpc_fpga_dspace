function pars_str =  init_net_floatL6(h5_file,~,~,~)
    ...
    fc4 = net.Layers(find(arrayfun(@(l) strcmp(l.Name, 'fc4'), net.Layers)));
    fc5 = net.Layers(find(arrayfun(@(l) strcmp(l.Name, 'fc5'), net.Layers)));
    fc6 = net.Layers(find(arrayfun(@(l) strcmp(l.Name, 'fc6'), net.Layers)));
    ...
    pars_str.fc4W = fc4.Weights;
    pars_str.fc4B = fc4.Bias;
    pars_str.fc5W = fc5.Weights;
    pars_str.fc5B = fc5.Bias;
    pars_str.fc6W = fc6.Weights;
    pars_str.fc6B = fc6.Bias;
