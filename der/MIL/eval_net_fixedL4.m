function y = eval_net_fixedL4(x_norm, pars_str, F_)
         x_norm_fixed = fi(x_norm, 1, pars_str.wordLength, pars_str.fracLength, F_);


        y = evaluateFixedPointNet(x_norm_fixed, pars_str.fc0W, pars_str.fc0B, pars_str.fc1W, pars_str.fc1B, pars_str.fc2W, pars_str.fc2B, pars_str.fc3W, pars_str.fc3B, pars_str.fc4W, pars_str.fc4B);
        y = double(y);

        function output = evaluateFixedPointNet(x_input, fc0W, fc0B, fc1W, fc1B, fc2W, fc2B, fc3W, fc3B, fc4W, fc4B)
