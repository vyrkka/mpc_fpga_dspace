...
void der(
    ...
    #pragma HLS INTERFACE ap_vld port=fc0_input,layer16_out 
    #pragma HLS PIPELINE 
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<weight2_t, 270>(w2, "w2.txt");
        nnet::load_weights_from_txt<bias2_t, 30>(b2, "b2.txt");
        nnet::load_weights_from_txt<weight5_t, 900>(w5, "w5.txt");
        nnet::load_weights_from_txt<bias5_t, 30>(b5, "b5.txt");
        nnet::load_weights_from_txt<weight8_t, 900>(w8, "w8.txt");
        nnet::load_weights_from_txt<bias8_t, 30>(b8, "b8.txt");
        nnet::load_weights_from_txt<weight11_t, 900>(w11, "w11.txt");
        nnet::load_weights_from_txt<bias11_t, 30>(b11, "b11.txt");
        nnet::load_weights_from_txt<weight14_t, 60>(w14, "w14.txt");
    ...
    nnet::dense<layer13_t, layer14_t, config14>(layer13_out, layer14_out, w14, b14); // fc4

    nnet::relu<layer14_t, result_t, relu_config16>(layer14_out, layer16_out); // relu4
