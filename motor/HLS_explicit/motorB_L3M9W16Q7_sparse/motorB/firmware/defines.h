...
typedef ap_fixed<16,7,AP_RND,AP_SAT> input_t;
typedef ap_fixed<16,7,AP_RND,AP_SAT> model_default_t;
...
typedef ap_fixed<16,7,AP_RND,AP_SAT> layer7_t;
typedef ap_fixed<18,8> relu1_table_t;
typedef ap_fixed<16,7,AP_RND,AP_SAT> layer8_t;
typedef ap_fixed<16,7> weight8_t;
typedef ap_fixed<16,7> bias8_t;
typedef ap_uint<1> layer8_index;
typedef ap_fixed<16,7,AP_RND,AP_SAT> layer10_t;
typedef ap_fixed<18,8> relu2_table_t;
typedef ap_fixed<16,7,AP_RND,AP_SAT> layer11_t;
typedef ap_fixed<16,7> weight11_t;
typedef ap_fixed<16,7> bias11_t;
typedef ap_uint<1> layer11_index;
typedef ap_fixed<16,7,AP_RND,AP_SAT> result_t;
