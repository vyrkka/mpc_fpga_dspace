function pars_str =  init_net_fixedL5(h5_file, W, Q, F_)
    wordLength = W;
    fracLength = W-Q;
    ...
    pars_str.fc4W = fi(fc4.Weights, 1, wordLength, fracLength, F_);
    pars_str.fc4B    = fi(fc4.Bias,    1, wordLength, fracLength, F_);
    pars_str.fc5W = fi(fc5.Weights, 1, wordLength, fracLength, F_);
    pars_str.fc5B    = fi(fc5.Bias,    1, wordLength, fracLength, F_);
end