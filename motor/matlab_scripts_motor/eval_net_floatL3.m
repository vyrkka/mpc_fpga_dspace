function y = eval_net_floatL3(x_norm, pars_str, ~)
    
    y = evaluateNet(x_norm, pars_str.fc0W, pars_str.fc0B, pars_str.fc1W, pars_str.fc1B, pars_str.fc2W, pars_str.fc2B, pars_str.fc3W, pars_str.fc3B);
    y = double(y);
    function output = evaluateNet(x_input, fc0W, fc0B, fc1W, fc1B, fc2W, fc2B, fc3W, fc3B)
