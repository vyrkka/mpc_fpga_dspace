...
function estimador_func_config(this_block)
  ...
  % Revision History:
  %
  %   01-Apr-2025  (22:23 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     C:\Users\fabus\Documents\model_composer_test\mpc_implicito1\estimador\estimador_func.v
  %
  %
  ...
  zhat_next_0_port.setType('Fix_32_16');
  ...
  zhat_next_1_port.setType('Fix_32_16');
  ...
  zhat_next_2_port.setType('Fix_32_16');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('zhat_prev_0').width ~= 32)
      this_block.setError('Input data type for port "zhat_prev_0" must have width=32.');
    end

    if (this_block.port('zhat_prev_1').width ~= 32)
      this_block.setError('Input data type for port "zhat_prev_1" must have width=32.');
    end

    if (this_block.port('zhat_prev_2').width ~= 32)
      this_block.setError('Input data type for port "zhat_prev_2" must have width=32.');
    end
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
this_block.addFile('estimador/estimador_func_flow_control_loop_pipe_sequential_init.v');
this_block.addFile('estimador/estimador_func_mul_32ns_32s_64_1_1.v');
this_block.addFile('estimador/estimador_func_mul_32s_32ns_64_1_1.v');
this_block.addFile('estimador/estimador_func_mux_32_32_1_1.v');
this_block.addFile('estimador/estimador_func_estimador_func_Pipeline_mvmult_row.v');
this_block.addFile('estimador/estimador_func_estimador_func_Pipeline_mvmult_row1.v');
this_block.addFile('estimador/estimador_func_estimador_func_Pipeline_mvmult_row2.v');
this_block.addFile('estimador/estimador_func_estimador_func_Pipeline_vadd_row.v');
this_block.addFile('estimador/estimador_func_estimador_func_Pipeline_vadd_row3.v');
this_block.addFile('estimador/estimador_func_mux_32_32_1_1_x.v');
this_block.addFile('estimador/estimador_func_estimador_func_Pipeline_VITIS_LOOP_66_1.v');
this_block.addFile('estimador/estimador_func.v');
return;
