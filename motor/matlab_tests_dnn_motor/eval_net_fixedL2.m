function y = eval_net_fixedL2(x_norm, pars_str, F_)
         x_norm_fixed = fi(x_norm, 1, pars_str.wordLength, pars_str.fracLength, F_);


        y = evaluateFixedPointNet(x_norm_fixed, pars_str.fc0W, pars_str.fc0B, pars_str.fc1W, pars_str.fc1B, pars_str.fc2W, pars_str.fc2B);
        y = double(y);

        function output = evaluateFixedPointNet(x_input, fc0W, fc0B, fc1W, fc1B, fc2W, fc2B)
