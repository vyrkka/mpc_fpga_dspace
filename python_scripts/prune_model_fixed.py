...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Prune a fixed-point quantized model by setting small weights to zero.')
    ...
    parser.add_argument('W', type=int, help="Total bit width of the fixed-point representation.")
    parser.add_argument('Q', type=int, help="Number of integer bits of the fixed-point representation.")
