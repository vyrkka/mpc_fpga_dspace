...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_size', type=float, default=0.15, help='Fraction of dataset used for testing (default: 0.15).')
    ...
    x_train, x_test, y_train, y_test = preprocess_dataset(args.dataset, args.nx, args.nu, args.test_size, split_seed=args.seed)
