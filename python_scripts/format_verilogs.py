...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Process and format Verilog files generated by HLS for use in System Generator')
    
    # Base routes - accepts multiple values (MANDATORY)
    parser.add_argument('--base-routes', 
                       nargs='+', 
                       required=True,
                       help='List of base directory paths where the projects are located.')

    # Carpetas verilogs - accepts multiple values (MANDATORY)
    parser.add_argument('--carpetas-verilogs', 
                       nargs='+', 
                       required=True,
                       help='List of subdirectories containing the Verilog files to be processed.')
    ...
    parser.add_argument('--es-red', 
                       type=int, 
                       default=0,
                       help='Flag to indicate if the Verilog represents a neural network (1 for True, 0 for False). Default is 0.')
    
    # Inputs - accepts multiple values
    parser.add_argument('--inputs', 
                       nargs='+',
                       help='List of input signal names to replace the default fc0_input (required if --es-red is 1).')
    
    # Outputs - accepts multiple values
    parser.add_argument('--outputs',
                       nargs='+', 
                       help='List of output signal names to replace the default layer outputs (required if --es-red is 1).')
